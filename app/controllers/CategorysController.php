...
class CategorysController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		$db = $this->GetModel();
		$tablename = $this->tablename = 'categorys';
		$fields = array('id');
		...
		$this->view->page_title ="Categorys";
		$this->view->render('categorys/list.php' , $data ,'main_layout.php');
	}
	/**
     * Load csv|json data
     * @return data
	...
	function import_data(){
		...
		$list_page = (!empty($_POST['redirect']) ? $_POST['redirect'] : 'categorys/list');
	...
	function view( $rec_id = null , $value = null){
		...
		if(!empty($record)){
			$this->view->page_title ="View  Categorys";
			$this->view->render('categorys/view.php' , $record ,'main_layout.php');
		}
		else{
			$page_error = null;
			if($db->getLastError()){
	...
	function add(){
		...
		$this->view->page_title ="Add New Categorys";
		$this->view->render('categorys/add.php' ,null,'main_layout.php');
	}
	/**
     * Edit Record Action 
	...
	function edit($rec_id = null){
		...
		$this->view->page_title ="Edit  Categorys";
		if(!empty($data)){
			$this->view->render('categorys/edit.php' , $data, 'main_layout.php');
		}
		else{
			if($db->getLastError()){
